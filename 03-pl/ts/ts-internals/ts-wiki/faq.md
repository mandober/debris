...
1. [Common "Bugs" That Aren't Bugs](#common-bugs-that-arent-bugs)
2. [Common Feature Requests](#common-feature-requests)
3. [Type System Behavior](#type-system-behavior)
...
type FirstName = string & {'persons names': {}}
