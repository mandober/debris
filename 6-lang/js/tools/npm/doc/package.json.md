...
* the name <= 214 characters, including scope
* can't start with a dot or underscore
* no uppercase letters
* the name will appear in URLs, CLI, as a folder - so, no unsafe characters
...
### directories.doc
* Put markdown files in here.
* Eventually, these will be displayed nicely, maybe, someday.

### directories.example
* Put example scripts in here.
* Someday, it might be exposed in some clever way.

### directories.test
* Put your tests in here.
* It is currently not exposed, but it might be in the future.
